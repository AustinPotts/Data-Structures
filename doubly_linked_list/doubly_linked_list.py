...
class DoublyLinkedList:
     ...
     def add_to_head(self, value):
         ...
         self.length += 1
         # if the head and tail are none set the head and tail to the new node created
     ...
     def add_to_tail(self, value):
         pass
         # create new node from the value passed in
         new_node = ListNode(value)
     ...
     def delete(self, node):
         ...
         # set the node to the next node and remove references to the head
         elif self.head == node:
     ...
     def get_max(self):
         ...
         while current:
             # if the current value is greater then the current max_value replace max+value with the current node
             # value
